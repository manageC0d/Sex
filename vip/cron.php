...
Ðang s? lý th?c hi?n tang LIKE cho ID: '.$this->id.'
<hr><hr><br>
</pre>';
    echo $w;
    }
...
$id= getid($uid,$tk);
if (!$id){
echo '<font color="red"><font><font>Sai ID ho?c TOKEN dã ch?t vui lòng ki?m tra l?i TOKEN!</font></font></font>';
}else{
$try->id = $id; 
