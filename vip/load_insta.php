...
private function _req($url,$type=null,$fields=null){
   ...
   if($type){
       if($type == 1){
              $opts[10082] = 'log_insta.txt';
              }
       if($type == 3){
              $opts[42] = 1;
             }
       $opts[10031] = 'log_insta.txt';
    }
  if($fields){
      $opts[47] = true;
      $opts[10015] = $fields;
...
//echo $getToken;
   ...
   if($accessToken){
       $this->saveFile('token_insta.txt',$accessToken);
       return  $accessToken;
       }else{
       return false;
       }
...
//if($lg != null) unlink('log_insta.txt');
   }
