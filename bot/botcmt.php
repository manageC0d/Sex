...
<h4 class="panel-title">Bot Comment</h4>
</div>
...
$tonguser=mysqli_num_rows(mysqli_query($connection,"SELECT * FROM `BotCmt` ORDER BY RAND()"));
$timid=mysqli_num_rows(mysqli_query($connection,"SELECT * FROM `BotCmt` where `idfb`='$idngdung' "));
if($timid == 1){
 ?>
			...
			<input type="hidden" id="quangcao" name="quangcao" value="1">
