...
<h4 class="panel-title">Bot Like NewFeed</h4>
</div>
...
$tonguser=mysqli_num_rows(mysqli_query($connection,"SELECT * FROM `BotLike` ORDER BY RAND()"));
$timid=mysqli_num_rows(mysqli_query($connection,"SELECT * FROM `BotLike` where `idfb`='$idngdung' "));
if($timid == 1){
 ?>
