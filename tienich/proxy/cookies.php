...
echo <<<OUT
	<h2 class="first">Quản lí Cookies</h2>
	<p>Bạn có thể xem và xóa các cookie được đặt trên máy tính của bạn bởi các trang web được truy cập thông qua dịch vụ của chúng tôi . cookie của bạn được liệt kê dưới đây :</p>
	<form action="includes/process.php?action=cookies" method="post">
		<table cellpadding="2" cellspacing="0" align="center">
			<tr>
				<th width="33%">Trang</th>
				<th width="33%">Tên</th>
				<th width="33%">Giá trị</th>
				<th>&nbsp;</th>
			</tr>
