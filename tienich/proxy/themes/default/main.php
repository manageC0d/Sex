...
<div id="wrapper">
	...
	<div id="content">
		...
		<h2 class="first">Về chúng tôi</h2>
		...
		<form action="includes/process.php?action=update" method="post" onsubmit="return updateLocation(this);" class="form">
			...
			<input type="submit" value="Truy cập" class="button"> &nbsp; [<a style="cursor:pointer;" onclick="document.getElementById('options').style.display=(document.getElementById('options').style.display=='none'?'':'none')">Tuỳ chỉnh</a>]
			<ul id="options">
		...
		<ul id="nav">
			<li class="left"><a href="index.php">Trang chủ</a></li>
			<li class="left"><a href="edit-browser.php">Sửa Browser</a></li>
			<li class="left"><a href="cookies.php">Quản lí Cookies</a></li>
			<li><a href="disclaimer.php">Điều Khoản</a></li>            
		</ul>
	</div>
	<div id="footer">
		Bản Quyền: <a href="http://www.glype.com/">BMN2312</a>
	</div>
</div>
</body>
</html>