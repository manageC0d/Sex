...
<h4 class="panel-title">Post Fanpage</h4>
</div>
<div class="panel-body" id="back">
	<div class="inqbox float-e-margins">
		<div class="inqbox-content">
			<h4><strong><p class="text-danger"> Hệ Thống Spam Post Toàn Bộ Các Fanpage</p></strong></h4>
			...
			<div class="form-group">
				<button class="btn btn-success btn-block" id="postfanpage" onclick="post_Fanpage();">
...
function post_Fanpage() {
    ...
    document.getElementById("postfanpage").disabled = true;
    $("#postfanpage").html('<i class="fa fa-refresh fa-spin"></i> Đang Tiến Hành');
    $("#message").html("");
    $('#star').show();
    ...
    $.post('done/post_post.php', {
        ...
        log(data);
        $("#postfanpage").html('<i class="fa fa-exchange"></i> Thực Thi');
