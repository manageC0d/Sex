...
<h4 class="panel-title">Post Wall Friends</h4>
</div>
<div class="panel-body" id="back">
	<div class="inqbox float-e-margins">
		<div class="inqbox-content">
			<h4><strong><p class="text-danger"> Hệ Thống Spam Post Tường Bạn Bè</p></strong></h4>
			...
			<div class="form-group">
				<button class="btn btn-success btn-block" id="postfriend" onclick="post_Friends();">
...
function post_Friends() {
    ...
    document.getElementById("postfriend").disabled = true;
    $("#postfriend").html('<i class="fa fa-refresh fa-spin"></i> Đang Tiến Hành');
    $("#message").html("");
    $('#star').show();
    ...
    $.post('done/post_post.php', {
        ...
        log(data);
        $("#postfriend").html('<i class="fa fa-exchange"></i> Thực Thi');
